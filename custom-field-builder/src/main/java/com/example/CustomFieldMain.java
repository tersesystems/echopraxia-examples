...
public class CustomFieldMain {
    ...
    public static void main(String[] args) {
        ...
        Condition ageCondition = pathCondition(
                (context) ->
                        context
